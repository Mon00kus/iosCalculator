  ...
  return (
    <View style= { globalStyles.calculatorContainer }>      
      ...
      <View style={globalStyles.row}>
        ...
        <CalculatorBotton onPress={moduleOper} label="%"   color= {colors.orange} blackText/>
        <CalculatorBotton onPress={ divideOper } label="÷"   color= {colors.orange} blackText/>
      </View>
      <View style={globalStyles.row}>
        ...
        <CalculatorBotton onPress={multiplyOper} label="x" color= {colors.orange} blackText/>
      </View>
          <View style={globalStyles.row}>
        ...
        <CalculatorBotton onPress={substractOper} label="-" color= {colors.orange} blackText/>
      </View>
          <View style={globalStyles.row}>
        ...
        <CalculatorBotton onPress={addOper} label="+" color= {colors.orange} blackText/>
      </View>
          <View style={globalStyles.row}>
        ...
        <CalculatorBotton onPress={()=> buildNumber('0')} label="0" color= {colors.darkGray}/>
          <CalculatorBotton onPress={ deleteLastNumber } label="del" color= {colors.orange} blackText/>
        <CalculatorBotton onPress={()=> buildNumber('.')} label="." color= {colors.darkGray}/>
        <CalculatorBotton onPress={ calculateResult } label="=" color= {colors.orange}blackText/>
      </View>
    </View>
  )
}